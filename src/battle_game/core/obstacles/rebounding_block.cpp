...
bool ReboundingBlock::IsIntersect(glm::vec2 a, glm::vec2 b, glm::vec2 c, glm::vec2 d) {
...
std::pair<glm::vec2, glm::vec2> ReboundingBlock::GetSurfaceNormal(glm::vec2 origin, glm::vec2 terminus) {
