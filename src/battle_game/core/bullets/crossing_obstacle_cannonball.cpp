...
CrossingObstaclesCannonball::CrossingObstaclesCannonball(GameCore *core,
                                                         uint32_t id,
                                                         uint32_t unit_id,
                                                         uint32_t player_id,
                                                         glm::vec2 position,
...
void CrossingObstaclesCannonball::Render() {
...
void CrossingObstaclesCannonball::Update() {
...
CrossingObstaclesCannonball::~CrossingObstaclesCannonball() {
  for (int i = 0; i < 5; i++) {
