...
Supertank::Supertank(GameCore *game_core, uint32_t id, uint32_t player_id)
...
bool Supertank::IsHit(glm::vec2 position) const {
...
const char *Supertank::Author() const {
  return "sparklist";
}
}  // namespace battle_game::unit
