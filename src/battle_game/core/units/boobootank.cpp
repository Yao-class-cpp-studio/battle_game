...
void boobootank::Render() {
  battle_game::SetTransformation(position_, rotation_);
  battle_game::SetTexture(0);
  battle_game::SetColor(game_core_->GetPlayerColorbooboo(player_id_));
...
void boobootank::TankMove(float move_speed, float rotate_angular_speed) {
...
bool boobootank::IsHit(glm::vec2 position) const {
