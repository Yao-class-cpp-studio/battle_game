...
Tank::Tank(GameCore *game_core, uint32_t id, uint32_t player_id, float max_health, float health, float attack, float defence, float speed)
    : Unit(game_core, id, player_id, max_health, health, attack, defence, speed) {
