...
QXTank::QXTank(GameCore *game_core, uint32_t id, uint32_t player_id)
...
void QXTank::TankMove(float move_speed, float rotate_angular_speed) {
...
bool QXTank::IsHit(glm::vec2 position) const {
...
const char *QXTank::UnitName() const {
  return "QXTank";
}

const char *QXTank::Author() const {
  return "QIXUAN";
}
}  // namespace battle_game::unit
