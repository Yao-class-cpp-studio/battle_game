...
Crit_Tank::Crit_Tank(GameCore *game_core, uint32_t id, uint32_t player_id)
...
void Crit_Tank::Update() {
  TankMove(3.0f, glm::radians(180.0f));
  TurretRotate();
  Fire();
}

void Crit_Tank::TankMove(float move_speed, float rotate_angular_speed) {
...
const char *Crit_Tank::Author() const {
  return "QIXUAN";
}
}  // namespace battle_game::unit
