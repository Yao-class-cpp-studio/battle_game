  ...
  if (!~tank_body_model_index) {
    auto mgr = AssetsManager::GetInstance();
    {
      ...
      tank_body_model_index = mgr->RegisterModel(
          {{{-0.9f, 1.1f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
           {{-0.9f, -1.1f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
           {{0.9f, 1.1f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
           {{0.9f, -1.1f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}}},
          {0, 1, 2, 1, 2, 3});
...
void Tank_xwx::TankMove(float move_speed, float rotate_angular_speed) {
...
bool Tank_xwx::IsHit(glm::vec2 position) const {
  ...
  return position.x > -0.9f && position.x < 0.9f && position.y > -1.1f &&
         position.y < 1.1f;
}
