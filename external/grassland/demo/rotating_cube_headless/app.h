...
class App {
 ...
 private:
  ...
  std::vector<std::unique_ptr<vulkan::Image>> depth_buffer_image_;
  std::vector<std::unique_ptr<vulkan::ImageView>> depth_buffer_image_view_;
  std::vector<std::unique_ptr<vulkan::Image>> color_buffer_image_;
  std::vector<std::unique_ptr<vulkan::ImageView>> color_buffer_image_view_;
